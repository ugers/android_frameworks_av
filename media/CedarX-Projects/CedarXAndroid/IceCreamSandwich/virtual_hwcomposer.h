...
#if (defined(__CHIP_VERSION_F23) || defined(__CHIP_VERSION_F51) || (defined(__CHIP_VERSION_F33) && CEDARX_ANDROID_VERSION<8) || (defined(__CHIP_VERSION_F50)) || (defined(__CHIP_VERSION_F67)))
