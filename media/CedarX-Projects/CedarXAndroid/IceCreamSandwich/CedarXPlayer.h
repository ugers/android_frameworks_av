...
//    status_t setSurfaceTexture(const sp<ISurfaceTexture> &surfaceTexture);
	...
	status_t getMediaPlayerInfo( struct MediaPlayerInfo* mediaPlayerInfo);
...
private:
    ...
    int32_t mCanSeek;
    int32_t mDisplayWidth, mDisplayHeight, mDisplayFormat;  //mDisplayWidth=vdeclib_display_width, mDisplayHeight=vdeclib_display_height,so when vdeclib rotate, we should careful! mDisplayFormat:destination format to send out. HWC_FORMAT_MBYUV422 or HAL_PIXEL_FORMAT_YV12
    int32_t mRenderToDE;
