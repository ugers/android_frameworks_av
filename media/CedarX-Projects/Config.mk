...
CEDARX_USE_HTTPLIVE_STREAM := Y
CEDARX_TOP := $(TOP)/frameworks/av/media/CedarX-Projects/CedarX
CEDARX_EXT_CFLAGS += -DCEDARX_ANDROID_VERSION=11
endif
ifeq ($(PLATFORM_VERSION),4.4.4)
CEDARX_ANDROID_VERSION := 11
CEDARX_ANDROID_CODE := KK44
...
#for 256M ddr
#CEDARX_EXT_CFLAGS += -DCEDARX_USE_DMA_ION_MEM_ALLOCATOR
else
  CEDARX_USE_SUNXI_MEM_ALLOCATOR := N
endif

ifeq ($(CEDARX_CHIP_VERSION),F23)
  CEDARX_USE_ION_MEM_ALLOCATOR := N
  CEDARX_USE_SUNXI_MEM_ALLOCATOR := N
endif
