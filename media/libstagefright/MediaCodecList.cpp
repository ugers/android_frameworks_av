...
void MediaCodecList::addMediaCodec(
    ...
    //getCallingProcessName(m_CallingProcess);
    if((strcmp(m_CallingProcess, "com.google.android.youtube") == 0) && (!strcmp(name, "OMX.allwinner.video.decoder.avc")))
    {
      ALOGD("com.google.android.youtube OMX.allwinner.video.decoder.avc change to OMX.google.h264.decoder");
      info->mName = "OMX.google.h264.decoder";
    } else
    {
        info->mName = name;
    }
