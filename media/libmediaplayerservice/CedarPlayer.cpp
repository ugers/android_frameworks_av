...
status_t CedarPlayer::setInputDimensionValue(int type, int value)
{
...
status_t CedarPlayer::setOutputDimensionValue(int type, int value)
{
...
status_t CedarPlayer::getMediaPlayerInfo( struct MediaPlayerInfo* mediaPlayerInfo)
{
	return mPlayer->getMediaPlayerInfo(mediaPlayerInfo);
}
